...
Bayesian modeling offers a different approach. Instead of a single "significant/non-significant" decision, it yields a [distribution]{.smallcaps} of plausible values for each effect, directly answering: "How strong is the effect?" and "How confident are we?"
