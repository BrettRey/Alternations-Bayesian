...
Extraposition shows a modest positive effect ($\beta_{\text{extrap}} =$ **0.30**, 90% CI: [0.06, 0.53]): extraposed clauses favour overt *that* compared to in-situ complements, consistent with the higher *that*-rates observed for adjective-headed extraposed constructions.
