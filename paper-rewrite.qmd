...
abstract: |
  ...
  knowledge -- systematic, learnable, and predictively robust. Using 302,522
  ...
  rates within a few percentage points. English grammar includes not just what's
  allowed, but how likely speakers are to choose among allowed options.
---
...
They differ little in propositional content, yet they aren't interchangeable. After *think*, speakers in conversation omit *that* nearly 90% of the time. After *prove*, writers in academic prose keep it over 80% of the time. This variation isn't noise: it's learned, verb-specific, register-sensitive, and predictively stable.
