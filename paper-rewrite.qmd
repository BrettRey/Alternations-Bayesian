...
abstract: |
  ...
  This paper argues that these probabilities are part of grammatical
  ...
  evidential bridge from descriptive pattern to grammatical knowledge. English
  grammar includes not just what's allowed, but how likely speakers are to
  choose among allowed options.
---
...
These sentences are propositionally near-equivalent—close enough that speakers regularly choose between them under the same communicative circumstances. Yet they aren't interchangeable. After *think*, speakers in conversation omit *that* nearly 90% of the time. After *prove*, writers in academic prose keep it over 80% of the time. This variation isn't noise: it's learned, verb-specific, register-sensitive, and predictively stable.

**The central claim of this paper:** English grammar includes not just what's allowed, but how likely speakers are to choose among allowed options. Alternation probabilities are grammatical knowledge.
...
Both function as complements of verbs (*think*, *say*, *prove*), adjectives (*sure*,
...
distinction isn't a sharp boundary. Rather, I argue that the alternation is
grammatical insofar as it is *causally entrenched* and *projectible*: it recurs
...
whether to draw a line between grammar and pragmatics, but whether this
...
the category supports robust generalisations.

A concern arises, however, about whether the UD-based extraction ([ccomp]{.smallcaps} +
[mark]{.smallcaps} with lemma *that*) reliably tracks the theoretical phenomenon
...
misanalysed relative clauses) and 91% recall (9% false negatives, mostly bare
clauses misparsed as other dependency types). Crucially, errors were not
...
written data. This suggests that the operationalisation is adequate for the
...
expectations about audience processing, and genre conventions. Importantly,
written registers—especially academic prose—are norm-governed in ways that spoken
...
therefore, is a socially stabilised convention: historically contingent but
nonetheless learnable, shared, and predictive. This doesn't weaken the claim
...
part of the shared grammatical knowledge of English speakers. If, however,
substantial divergence appears, that would be informative too: it would suggest
